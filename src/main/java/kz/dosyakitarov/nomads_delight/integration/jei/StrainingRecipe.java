...
public class StrainingRecipe {
    private final ItemStack input;
    private final ItemStack output;
    private final ItemStack extractionTool;
    private final int churnTimeTicks;

    public StrainingRecipe(ItemStack input, ItemStack output, int churnTimeTicks) {
        this(input, output, ItemStack.EMPTY, churnTimeTicks);
    }

    public StrainingRecipe(ItemStack input, ItemStack output, ItemStack extractionTool, int churnTimeTicks) {
        this.input = input;
        this.output = output;
